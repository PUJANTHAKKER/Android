...
public class DonorLogin extends AppCompatActivity {
    ...
    /*    mToolbar=(Toolbar)findViewById(R.id.login_toolbar);
        ...
        mUserDatabase= FirebaseDatabase.getInstance().getReference().child("Donors");
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    String deviceToken= FirebaseInstanceId.getInstance().getToken();
                            ...
                            Intent mainIntent=new Intent(DonorLogin.this,MainActivity.class);
                    ...
                    mLoginProgress.hide();
                    Toast.makeText(DonorLogin.this, "Authentication failed", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
